<template>
  <div ref="wrapRef" :class="getWrapperClass">
    <BasicForm
      :class="{ 'table-search-area-hidden': !getBindValues.formConfig?.schemas?.length, 'clip-block-div': isQD }"
      submitOnReset
      v-bind="getFormProps"
    ...
    >
      ...
      <template #formHeaderForTable v-if="isQD">
        <div class="new-title position-relative mb-8px w-full pl-7px">
          <div>
            <TableTitle title="查询条件" useTo="TableForm" />
          </div>
        </div>
      </template>
    </BasicForm>
    ...
    <a-form-item-rest>
      ...
      <a-form-item :class="isQD ? 'clip-block-div' : ''">
        <Table
          ref="tableElRef"
        ...
        <img src="@/assets/business/img/common-section-left.png" class="position-absolute left-0 top-120px" v-if="isQD" />
        <img src="@/assets/business/img/common-section-right.png" class="position-absolute right-0 top-120px" v-if="isQD" />
      </a-form-item>
    </a-form-item-rest>
  </div>
</template>
  ...
  html[data-theme='lightQD'] {
    ...
    .clip-block-div {
      ...
      -webkit-clip-path: polygon(
        ...
        calc(100% - 9px) 100%,
        calc(100% - 60px) 100%,
        calc(100% - 69px) calc(100% - 6px),
        calc(100% - 151px) calc(100% - 6px),
        calc(100% - 160px) 100%,
        9px 100%,
        0 calc(100% - 6px),
        0 6px
