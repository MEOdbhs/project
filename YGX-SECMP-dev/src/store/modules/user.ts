...
import { doLogout, getUserInfo, loginApi, phoneLoginApi, thirdLogin, getEnterpriseListApi } from '/@/api/sys/user'
...
export const useUserStore = defineStore({
    ...
    actions: {
        setCurrentEnterpriseCode(code: string) {
            this.currentEnterpriseCode = code
        },
        ...
        async getUserInfoAction(): Promise<UserInfo | null> {
            ...
            if (userInfo) {
                ...
                const res = await getEnterpriseListApi({ orgCode: userInfo?.orgCode })
                userInfo.enterpriseList = res
