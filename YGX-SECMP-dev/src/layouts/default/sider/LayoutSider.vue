<template>
  ...
  >
    ...
    <LayoutMenu :theme="getMenuTheme" :menuMode="getMode" :splitType="getSplitType" :currentPathObj="currentPathObj" />
...
<style lang="less">
  ...
  html[data-theme='dark'] {
    .@{prefix-cls} {
      //background: url('@/assets/business/img/menu-bg.jpg') no-repeat !important;
