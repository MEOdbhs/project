  ...
  <div class="tab-form-wrap block-list-wrap">
    ...
    <div v-for="(item, index) in listData" :key="item._id" class="record-block">
      <div class="block-header">
        <span class="block-title">采掘施工单位{{ indexLabel(index) }}</span>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <div class="field-wrap">
              <div class="field-label required-label">企业名称</div>
              <a-input v-model:value="item.companyName" :disabled="disabled" placeholder="请输入企业名称" />
            </div>
          </a-col>
          <a-col :span="12">
            <div class="field-wrap">
              <div class="field-label required-label">详细地址</div>
              <a-input v-model:value="item.address" :disabled="disabled" placeholder="请输入详细地址" />
            </div>
          </a-col>
          <a-col :span="12">
            <div class="field-wrap">
              <div class="field-label required-label">主体类型</div>
              <a-input v-model:value="item.companyEconomyType" :disabled="disabled" placeholder="请输入主体类型" />
            </div>
          </a-col>
          <a-col :span="12">
            <div class="field-wrap">
              <div class="field-label required-label">经营范围</div>
              <a-input v-model:value="item.businessNature" :disabled="disabled" placeholder="请输入经营范围" />
            </div>
          </a-col>
          <a-col :span="12">
            <div class="field-wrap">
              <div class="field-label">上级单位名称</div>
              <a-input v-model:value="item.parentCompany" :disabled="disabled" placeholder="请输入上级单位名称" />
            </div>
          </a-col>
          <a-col :span="12">
            <div class="field-wrap">
              <div class="field-label">采掘施工单位工商营业执照</div>
              <PdfUploadSimple v-model:value="item.miningLicence" :disabled="disabled" />
            </div>
          </a-col>
          <a-col :span="12">
            <div class="field-wrap">
          ...
          <a-col :span="12">
            <div class="field-wrap">
              <div class="field-label">主要负责人电话</div>
              <a-input v-model:value="item.phone" :disabled="disabled" placeholder="请输入主要负责人电话" />
            </div>
          </a-col>
          <a-col :span="12">
            <div class="field-wrap">
              <div class="field-label required-label">安全生产许可证编号</div>
              <a-input v-model:value="item.safeLicenceNumber" :disabled="disabled" placeholder="请输入安全生产许可证编号" />
            </div>
          </a-col>
          <a-col :span="12">
            <div class="field-wrap">
          ...
          <a-col :span="12">
            <div class="field-wrap">
              <div class="field-label">矿山工程施工资质范围</div>
              <a-input v-model:value="item.ksgcsgzzfw" :disabled="disabled" placeholder="请输入矿山工程施工资质范围" />
            </div>
          </a-col>
          <a-col :span="12">
            <div class="field-wrap">
              <div class="field-label required-label">资质等级</div>
              <a-input v-model:value="item.ltZzdj" :disabled="disabled" placeholder="请输入资质等级" />
            </div>
          </a-col>
        </a-row>
      </div>
...
const REQUIRED_FIELDS: { key: string; label: string }[] = [
  ...
  { key: 'companyEconomyType', label: '主体类型' },
  { key: 'businessNature', label: '经营范围' },
  { key: 'userName', label: '主要负责人姓名' },
  { key: 'safeLicenceNumber', label: '安全生产许可证编号' },
  { key: 'safeStartDate', label: '安全生产许可证有效期限始' },
  { key: 'safeExpiresDate', label: '安全生产许可证有效期限至' },
  { key: 'ltZzdj', label: '资质等级' },
]
