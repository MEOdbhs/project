<template>
  <div class="tab-form-wrap">
    <div class="list-tab-header">
      <span class="list-tab-title">"五科"人员信息</span>
    ...
    <a-modal
      ...
      :title="editIndex === -1 ? '新增人员信息' : '编辑人员信息'"
      width="860px"
    ...
    >
      <a-form ref="modalFormRef" :model="editRow" layout="vertical" class="row-edit-form">
        <a-row :gutter="16">
          ...
          <a-col :span="12">
            <a-form-item label="职务" name="positionSection" :rules="req('请选择职务')">
              <JDictSelectTag v-model:value="editRow.positionSection" dictCode="positionSection" placeholder="请选择" />
            </a-form-item>
          </a-col>
          <!-- 地下矿山(4) 和 露天矿山(2) 才显示兼任字段 -->
          <a-col v-if="isDx || isLt" :span="12">
            <a-form-item label="兼任职务" name="balancePositionSection">
              <JDictSelectTag v-model:value="editRow.balancePositionSection" dictCode="balancePositionSection" placeholder="请选择" allow-clear />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="分管工作" name="chargeWorkSection" :rules="req('请选择分管工作')">
              <JDictSelectTag v-model:value="editRow.chargeWorkSection" dictCode="chargeWorkSection" placeholder="请选择" />
            </a-form-item>
          </a-col>
          <a-col v-if="isDx || isLt" :span="12">
            <a-form-item label="兼管工作" name="balanceWorkSection">
              <JDictSelectTag v-model:value="editRow.balanceWorkSection" dictCode="balanceWorkSection" placeholder="请选择" allow-clear />
            </a-form-item>
          </a-col>
          <a-col :span="12">
...
const columns = [
  ...
  { title: '职务', dataIndex: 'positionSection', key: 'positionSection', width: 120 },
  { title: '分管工作', dataIndex: 'chargeWorkSection', key: 'chargeWorkSection', width: 120 },
...
watch(
  () => props.detail,
  (val) => {
    listData.value = val?.fivePersonDTOList ? [...val.fivePersonDTOList] : []
  },
