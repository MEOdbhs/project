...
enum Api {
  listPage = '/main-app/YjjksbCalibrationRecord/listPage',
  saveOrUpdate = '/main-app/YjjksbCalibrationRecord/saveOrUpdate',
  // deleteItem = '/main-app/YjjksbCalibrationPlan/deleteFlagById',
  getViewById = '/main-app/YjjksbCalibrationRecord/getViewById',
