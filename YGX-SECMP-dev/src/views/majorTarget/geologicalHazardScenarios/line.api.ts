...
enum Api {
  listPage = '/main-app/ZdfhmbGeohazardInfo/listPage',
  saveOrUpdate = '/main-app/ZdfhmbGeohazardInfo/allSaveOrUpdate',
  deleteItem = '/main-app/ZdfhmbGeohazardInfo/deleteSubById',
  getViewById = '/main-app/ZdfhmbGeohazardInfo/getAllViewById',
}
/**
 * 列表(分页)
 * @param params
