...
enum Api {
  listPage = '/main-app/HazardEntSafetyInfo/listPage',
  saveOrUpdate = '/main-app/HazardEntSafetyInfo/saveOrUpdate',
  deleteItem = '/main-app/HazardEntSafetyInfo/deleteFlagById',
}
/**
 * 列表(分页)
 * @param params
