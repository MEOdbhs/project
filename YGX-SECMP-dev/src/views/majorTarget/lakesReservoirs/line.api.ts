...
enum Api {
  listPage = '/main-app/ZdfhmbWaterbodyInfo/list',
  // list = '/system/ChemicalsDangerous/list',
  saveOrUpdate = '/main-app/ZdfhmbWaterbodyInfo/allSaveOrUpdate',
  deleteItem = '/main-app/ZdfhmbWaterbodyInfo/deleteSubById',
  getViewById = '/main-app/ZdfhmbWaterbodyInfo/getAllViewById',
