...
enum Api {
  //主表
  listPage = '/main-app/ZdfhmbFirewatchInfo/listPage',
  saveOrUpdate = '/main-app/ZdfhmbFirewatchInfo/allSaveOrUpdate',
  deleteItem = '/main-app/ZdfhmbFirewatchInfo/deleteSubById',
  getViewById = '/main-app/ZdfhmbFirewatchInfo/getViewById',
