    ...
    <div class="account-data">
      ...
      <div class="account-detail">
        ...
        <div class="margin-bottom-10 font-size-13">
          <span class="gray-75 item-label">用户名</span>
          <span class="gray-3">{{ userInfo.username }}</span>
        </div>
        <div class="margin-bottom-10 font-size-13">
        ...
        <div class="margin-bottom-10 nowarp font-size-13">
          <span class="gray-75 item-label">部门</span>
          <span class="gray-3">{{ userInfo.orgCodeTxt ? userInfo.orgCodeTxt : "未填写" }}</span>
        </div>
