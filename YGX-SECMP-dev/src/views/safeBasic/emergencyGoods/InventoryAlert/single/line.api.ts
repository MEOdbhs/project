...
enum Api {
  listPage = '/main-app/YjaqxxkWarningRecord/listPage',
  deleteItem = '/main-app/YjaqxxkInventoryPlan/deleteFlagById',
  getViewById = '/main-app/YjaqxxkWarningRecord/getViewById',
  exportExcel = '/main-app/SfDeviceSafeCheck/export',
  saveOrUpdate = '/main-app/YjaqxxkWarningRecord/handleData',
