...
enum Api {
  listPage = '/main-app/RescueChemicalDispose/list',
  // list = '/system/ChemicalsDangerous/list',
  saveOrUpdate = '/main-app/RescueChemicalDispose/saveOrUpdate',
  deleteItem = '/main-app/RescueChemicalDispose/deleteFlagById',
