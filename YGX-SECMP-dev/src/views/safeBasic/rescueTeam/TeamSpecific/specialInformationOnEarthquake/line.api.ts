...
enum Api {
  listPage = '/main-app/RescueWreckage/list',
  list = '/sys/sysDepart/queryTreeList',
  saveOrUpdate = '/main-app/RescueWreckage/saveOrUpdate',
  deleteItem = '/main-app/RescueWreckage/deleteFlagById',
  getViewById = '/main-app/RescueWreckage/getViewById',
