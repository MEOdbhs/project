...
enum Api {
  listPage = '/main-app/RescueTeamOrganization/list',
  // list = '/system/ChemicalsDangerous/list',
  saveOrUpdate = '/main-app/RescueTeamOrganization/saveOrUpdate',
  deleteItem = '/main-app/RescueTeamOrganization/deleteFlagById',
