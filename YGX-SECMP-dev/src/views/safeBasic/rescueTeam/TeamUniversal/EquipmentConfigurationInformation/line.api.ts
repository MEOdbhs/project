...
enum Api {
  listPage = '/main-app/RescueTeamEquipment/list',
  // list = '/system/ChemicalsDangerous/list',
  saveOrUpdate = '/main-app/RescueTeamEquipment/saveOrUpdate',
  deleteItem = '/main-app/RescueTeamEquipment/deleteFlagById',
