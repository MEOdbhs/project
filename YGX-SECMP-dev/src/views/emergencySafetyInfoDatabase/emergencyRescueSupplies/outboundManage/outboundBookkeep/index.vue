...
<template>
    <BasicTable @register="registerTable">
        <template #tableTitle>
            <a-button v-auth="'outboundBookkeep:add'" type="primary" preIcon="ant-design:plus-outlined" @click="handleAdd">新增</a-button>
        </template>
...
import { columns, searchFormSchema } from './bookkeep.data'
import { listPage,deleteFlagById } from './bookkeep.api'
...
const { tableContext } = useListPage({
    ...
    tableProps: {
        ...
        formConfig: {
            ...
            autoAdvancedCol:4,
            fieldMapToTime: [['voucherDate', ['startVoucherDate', 'endVoucherDate'], 'YYYY-MM-DD']],
        },
        actionColumn: {
            width: 200,
        },
...
function getTableAction(record) {
    return [
        ...
        },
        {
            ...
            auth:'outboundBookkeep:edit',
        },
        {
            label: '删除',
            auth:'outboundBookkeep:delete',
            popConfirm: {
                title: '是否确认删除',
