...
enum Api {
    saveOrUpdate = '/main-app/YjaqxxkMaterialOutboundAccounting/saveOrUpdate',
    getViewById = '/main-app/YjaqxxkMaterialOutboundAccounting/getViewById',
    deleteFlagById = '/main-app/YjaqxxkMaterialOutboundAccounting/deleteFlagById',
    listPage = '/main-app/YjaqxxkMaterialOutboundAccounting/listPage',
}
