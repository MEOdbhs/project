...
enum Api {
    saveOrUpdate = '/main-app/YjaqxxkMaterialOutboundConfirm/saveOrUpdate',
    getViewById = '/main-app/YjaqxxkMaterialOutboundConfirm/getViewById',
    deleteFlagById = '/main-app/YjaqxxkMaterialOutboundConfirm/deleteFlagById',
    listPage = '/main-app/YjaqxxkMaterialOutboundConfirm/listPage',
}
