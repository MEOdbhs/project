...
<template>
    <BasicTable @register="registerTable">
        <template #tableTitle>
            <a-button v-auth="'rescueBookkeep:add'" type="primary" preIcon="ant-design:plus-outlined" @click="handleAdd">新增</a-button>
        </template>
...
function getTableAction(record) {
    return [
        ...
        },
        {
            ...
            auth:'rescueBookkeep:edit',
        },
        {
            label: '删除',
            auth:'rescueBookkeep:delete',
            popConfirm: {
                title: '是否确认删除',
